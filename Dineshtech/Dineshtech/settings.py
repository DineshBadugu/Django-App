"""
Django settings for Dineshtech project.
...
SECRET_KEY = 'django-insecure-9pa1iac#c0o6sze%xfczj9*8(5p+e(dmrb*84!fsnc32(4l$^i'
...
WSGI_APPLICATION = 'Dineshtech.wsgi.application'
